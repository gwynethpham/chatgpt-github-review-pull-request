...
const PROMPT = (0, core_1.getInput)('prompt') || promptsConfig_1.default[promptsConfig_1.Prompt.IMPROVE_MENNT];
const LANGUAGE = (0, core_1.getInput)('language') || 'english';
const promptGenerateByLanguage = (patch) => {
